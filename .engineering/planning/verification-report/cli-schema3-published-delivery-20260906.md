...
id: verification-report:cli-schema3-published-delivery-20260906
kind: verification-report
status: draft
title: Published schema3 source and verified public documentation delivery
relations:
- verifies: story:personal-gitlab-schedules-are-discoverable-and-governed
- verifies: story:rate-limit-in-the-protocol
revision: 1
---
## Published source and Website closure

Connectors PR 18 is merged at exact main 0c69450921ab1794c81dadec915b717a61bf0983 with CI 34037821332 successful. Its schema 3 public documentation is delivered by automatic Atlas run 34039715421 using the complete source-set/v1 and layout/provenance v2 publication. The original complete retained Website and independent automatic publication report is preserved verbatim below; its earlier statement that Website branch publication remains pending describes that earlier verification boundary.

Website PR 7 subsequently merged at 2026-09-06T15:07:30Z to d914fa947cc3e497e8770bb814af36d55b880f5c. Exact PRCI34040841314 and mainCI34041314425 are successful; all four introduced direct commits have both expected bot identities. Main tree35763f07036b742348f0e23dfad66736efe55d7a equals the reviewed source. The134 nonplanning source hashes remain equal to the locally verified5430e471 snapshot; the final change is planning evidence and lifecycle closure. The complete published Website report is verification-report:cli-schema3-website-delivery-20260906 in that repository.

After publication, root archived the retained1331-file build and verified every archived member's bytes. The archive SHA256 is 62d2cccddc954062439efebc74f6307c572f471ad4943880d77c8a925d08a220. Its archive, complete source inventory and cleanup records remain under ~/.cache/cw6/p. The first manager finish refused the five owned ignored build/install directories; that refusal remains recorded. After verifying no worktree process, all 134 source hashes and the archive, root cleaned only .cache, .docusaurus, .generated, build and node_modules, verified the same source hashes again and obtained a clean finish. The full GC dry-run was reviewed; only exact idwt-5b72ec73c229 was passed to apply, which verified published main/branch/PR recovery and removed that managed tree. The completed schema 3 candidate idwt-af054beacfba was similarly finished and removed earlier. No other record was selected or source/evidence deleted.

Publication is complete for these two implemented stories. This records no release/tag, schema 4/OAuth/authentication completion, consumer adoption or source installation. The held credential decision and prior unrelated full-Atlas-fence failures remain unchanged. Final supported-source installation after the remaining wave is still outstanding.

## Retained complete delivery report
