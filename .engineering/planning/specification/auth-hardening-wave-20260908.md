...
|---|---|---|---|---|---|---|
| integration | connectors-v2-auth-wave-20260908 | wave/auth-hardening-20260908 / 2a4404958449b1b91c5d494c5e4473ab6725bd8f (gate head; closing record follows) | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-wave-20260908 | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-wave-20260908/target (removed or never created) | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-wave-20260908/.local/waves/auth-hardening-20260908/integration (evidence copied, disposable contents removed) | removed by managed GC; recovery in local-recovery |
| refresh | connectors-v2-auth-refresh-20260908 | impl/contracts-refresh-coordination / 9fa4ba0346552fd3c34acd25e974717fd4c8c61c | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-refresh-20260908 | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-refresh-20260908/target (removed or never created) | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-refresh-20260908/.local/waves/auth-hardening-20260908/refresh (evidence copied, disposable contents removed) | removed by managed GC; recovery in local-recovery |
| evidence | connectors-v2-auth-evidence-20260908 | impl/contracts-credential-evidence / f55020ae799464ac09dfcc5a3ac54d02edc213b7 | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-evidence-20260908 | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-evidence-20260908/target (removed or never created) | ~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-evidence-20260908/.local/waves/auth-hardening-20260908/evidence (evidence copied, disposable contents removed) | removed by managed GC; recovery in local-recovery |
...
gate: exit=exit status: 0 ["specify", "compile", "--path", "ess", "--out", "~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-wave-20260908/.local/tmp/gate-mpCOj4/connectors-ir.json"]
...
gate: exit=exit status: 0 ["verify", "conform", "synthesize", "--path", "ess", "--target", "ir", "--scenarios", "~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-wave-20260908/.local/tmp/gate-mpCOj4/authored-scenarios", "--out", "~/.local/state/worktree/trees/b10x/connectors_v2/connectors-v2-auth-wave-20260908/.local/tmp/gate-mpCOj4/contract-conformance.json"]
...
## Cleanup completion after operator request

On the operator’s subsequent “commit and cleanup” instruction, main was already clean at `f5848015640aedcec2edcf4f985a881b3e5c35e4`. Created an independent bare local Git backup (no hardlinks/alternates) at `~/.local/state/worktree/recovery/connectors_v2.git`, configured as `local-recovery`; no external publication occurred. Git fsck completed successfully and the manager proved current recovery through its advertised refs. The three wave trees were clean, had no leases and their heads were reachable from main. Marked each finished, reviewed the exact-id GC dry-run (all three eligible), then applied those same ids. All three removal receipts are preserved in `docs/waves/auth-hardening-20260908/integration/managed-cleanup.json`. This supersedes the earlier retained-tree handoff. Existing design and Kubernetes drive trees were left untouched. The persistent local backup is retained for recovery.
