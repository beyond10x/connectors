...
E23/E24 are fixed: ordinary SIP dial/list operations, duplex session messages and media signal/interrupt messages have distinct owners; RTVBP redemption remains capability state, not an invented evidence name. SIP static_entry is managed/versioned custody. See docs/evidence/media-controls-20260909/verification.md.
