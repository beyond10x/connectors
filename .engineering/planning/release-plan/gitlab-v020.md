...
## Integration instruction — 2026-09-11

The operator subsequently instructed this side conversation to push the tag and merge into main now. That instruction supersedes the earlier coordination hold. Integrate immutable release commit 93a31da5078440f354704017fa86e4a3a100becf into main based on 3006897a60c77c4dfb72ffde9e11e582cee74088, retaining both post-release clock and approval-policy commits. Preserve all ongoing uncommitted adapter-generation edits. The annotated v0.2.0 tag stays at the original verified release; the newer main merge is not a retagged release.
