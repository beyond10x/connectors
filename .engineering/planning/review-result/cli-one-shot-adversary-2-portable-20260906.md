...
id: review-result:cli-one-shot-adversary-2-portable-20260906
kind: review-result
status: active
title: CLI one-shot final adversary pass 2026-09-06 portable record
relations:
...
Mechanical recording transformation: local Markdown links are rendered as code-form label/path references; all original prose, findings and counts are retained. No review was rerun.
