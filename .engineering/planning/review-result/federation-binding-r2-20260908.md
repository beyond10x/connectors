...
- FB-04: distinct compact-JWS types and audiences separate delivery from issuer approval. Exact raw body/method/receiver/path are authenticated; GET describe has an empty body and private nonce correlation while its public request_id remains null. Strict duplicate or unknown/header/encoding rules and the correlated TLS response path address the prior ambiguity.
