...
**IS1 · P2 — A concurrent cache miss can reject a replay because its claim was spent by the winner.** Location: [semantics.md:101](~/beyond10x/connectors_v2/contracts/operations/v1alpha1/semantics.md:101), with the winner recheck currently only at line 103.
