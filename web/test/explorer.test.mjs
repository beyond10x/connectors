...
// The explorer is currently a local prototype. Its legacy base remains a deterministic fixture,
// not a claim that this repository owns a Pages deployment. Public docs and the project Pages
// facade are generated by the unified Website publication path.
test('the local explorer build keeps its declared asset prefix without claiming a custom domain', () => {
  assert.equal(
    existsSync(path.join(webRoot, 'public', 'CNAME')),
    false,
    'the local explorer must not claim a custom domain or compete with unified Pages delivery'
  )
