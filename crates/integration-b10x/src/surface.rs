use protocol::audio::{
    SPEECH_SPEAK_OPERATION, SPEECH_SPEAK_TOOL_REF, SPEECH_STATUS_OPERATION,
    SPEECH_STATUS_TOOL_REF,
};
use protocol::browser::{
    BROWSER_CLOSE_OPERATION, BROWSER_CLOSE_TOOL_REF, BROWSER_GOTO_OPERATION,
    BROWSER_GOTO_TOOL_REF, BROWSER_OPEN_OPERATION, BROWSER_OPEN_TOOL_REF,
