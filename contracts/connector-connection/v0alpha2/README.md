...
v1 bundle and deployed v1 reader remain unchanged. Ordinary commands, results,
errors and trusted session validation reuse that reader losslessly.
...
`completion_endpoint` or `browser_completion_url`. The frozen v1 validator still
