...
Persistence ownership is consolidated in [design §31](../../docs/design.md#31-host-persistence-ownership-and-atomicity). The executing leaf owns DelegationNoncePort and ApprovalSpendPort; their exact uniqueness/retention differ from MutationKeyPort and each hop’s ExecutionAuditPort. This inventory does not supply a backend or execute its atomicity predicates.
