...
- **Family:** datasources. Siblings: [records](../../records/v1alpha1/semantics.md), [logs](../../logs/v1alpha1/semantics.md), relational (in [service v1alpha1](../../../service/v1alpha1/semantics.md)).
- **Recorded:** 2026-09-08.
...
- Mediated route (Grafana proxy) → same outputs as direct against the same fixture (route transparency, see [mediated_route](../../../discovery/mediated_route/v1alpha1/semantics.md)).
