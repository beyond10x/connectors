...
- Before the monorepo migration, the component workflow covered repository links, story-index
  ...
  [`scripts/check-local.sh --all`](https://github.com/beyond10x/b10x/blob/bf6859717f986dc0e2a3b8a713e087d426741d92/scripts/check-local.sh); no hosted workflow currently
