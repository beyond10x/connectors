...
architecture RFC 0004 (`architecture/rfcs/0004-satellite-federation.md`) ·
architecture RFC 0013 (`architecture/rfcs/0013-credential-custody-follows-connector-placement.md`) ·
architecture ADR 0032 (`architecture/adr/0032-central-managed-credential-custody-is-bounded.md`)
