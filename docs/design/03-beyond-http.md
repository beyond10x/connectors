...
[architecture ADR 0018 — Connectors satellites federate outward under bounded authority](https://github.com/b10x/b10x/blob/main/architecture/adr/0018-connectors-satellite-federation.md).
...
[Architecture ADR 0016 — Direct-byte establishment uses operation-scoped authority](https://github.com/b10x/b10x/blob/main/architecture/adr/0016-operation-scoped-session-authority.md)
...
[architecture ADR 0010 — Beyond HTTP is a five-axis connector model](https://github.com/b10x/b10x/blob/main/architecture/adr/0010-beyond-http-is-a-five-axis-connector-model.md).
...
[ADR 0015 — Foundation services share one trust envelope](https://github.com/b10x/b10x/blob/main/architecture/adr/0015-foundation-trust-envelope.md)
through
[ADR 0019 — Foundation contracts ship as signed reproducible bundles](https://github.com/b10x/b10x/blob/main/architecture/adr/0019-contract-release-and-conformance.md).
